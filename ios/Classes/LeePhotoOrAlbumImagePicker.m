...
- (NSInteger)AVAuthorizationStatusIsGranted  {
    ...
    NSInteger authStatusVedio = [AVCaptureDevice authorizationStatusForMediaType:mediaType];  // 相机授权
    NSInteger authStatusAlbm  = [PHPhotoLibrary authorizationStatus];                         // 相册授权
